...
class CustomerDashboard:
    def __init__(self, root, customer_id, logout_callback=None):
        ...
        # ------------------ COLORS (deep dark + light) ------------------
        self.color_sidebar_bg = self.theme_colors.get("sidebar_bg", "#050816")   # very deep dark
    ...
    def build_sidebar(self):
        ...
        theme_toggle_btn.pack(side=BOTTOM, pady=(0, 10))
    ...
    def show_bookings(self):
        ...
        table.tag_configure("oddrow", background="#f3f4f6")
        ...
        for col in columns:
            ...
            if col == "ID":
                ...
                table.column(col, width=160, stretch=True)
